...
JsonMapper.prototype._init = function(context, schema, json)
{
    ...
    Object.defineProperty(context, '_clone', {
        value: this._clone.bind(context)
    });

    Object.defineProperty(context, '_extend', {
        value: this._extend.bind(context)
    });
};
...
JsonMapper.prototype._getPath = function(path, root)
{
    ...
    {
        var val = _this._clone(node || root || this),
...
JsonMapper.prototype._extend = function(obj)
{
...
JsonMapper.prototype._clone = function(obj) {
    if (obj !== Object(obj)) return obj;
    return Object.prototype.toString.call(obj) == '[object Array]' ? obj.slice() : this._extend({}, obj);
};
